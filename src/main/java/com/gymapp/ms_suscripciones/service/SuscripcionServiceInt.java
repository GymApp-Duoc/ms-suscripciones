...
public interface SuscripcionServiceInt {
    ...
    List<SuscripcionResponseDTO> listarPorTipoPlan(String tipoPlan);
    List<SuscripcionResponseDTO> listarProximasAVencer(int dias);
    Double calcularIngresosTotales();
    List<SuscripcionResponseDTO> listarSuscripcionesRecientes(int dias);
}